...
public class ProcessExecutor1 {
	...
	private static void bind(ProcessLayer layer, Channel channel) {
	    ...
	    session.init(new Identificator(1), "localhost:9888", 
	    		new InetSocketAddress[] { creanteSocketAddress("localhost:9889"), creanteSocketAddress("localhost:9890") });
